...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[100svh] flex items-start sm:items-center justify-center overflow-hidden pt-24 sm:pt-28 lg:pt-0">
      {/* Background */}
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] items-center gap-10">
          <div className="text-center lg:text-left">
            ...
            <motion.p
              ...
              className="text-muted-foreground max-w-xl lg:max-w-none mx-auto lg:mx-0 mb-8 leading-relaxed"
            >
              {t("hero.subtitle")}
            </motion.p>
          ...
          >
            <div className="relative w-56 h-56 sm:w-72 sm:h-72 rounded-3xl overflow-hidden border border-border/60 bg-card/70 backdrop-blur">
              <img
                src={profileImage}
                alt="Radmehr Akbari"
